...
PKG_DIR="$HOME/Library/Application Support/Sublime Text 3/Packages"
...
[[ -e ~/bin/subl ]] || ln -s '/Applications/Sublime Text 3.app/Contents/SharedSupport/bin/subl' ~/bin/subl
...
echo  "Sublime Text 3 Package Manager installation:"
echo  "https://sublime.wbond.net/installation#st3"
